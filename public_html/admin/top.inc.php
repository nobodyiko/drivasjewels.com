            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="category_dash.php" > Category Dashboard</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="banner_dash.php" > Banner Dashboard</a>
                  </li>
                   <li class="menu-item-has-children dropdown">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="testimonial.php" > Testimonial Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="users.php" > User Master</a>
                  </li>
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="size.php" > Varient Master</a>
                  </li>
