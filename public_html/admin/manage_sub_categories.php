                        ...
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
									...
									<select name="categories_id" required class="form-control" style="border: 0.5px solid #d9e0e7;
    margin-top: 10px;
    margin-bottom: 10px;">
								...
								<div class="form-group">
									...
									<input type="text" name="sub_categories" placeholder="Enter sub categories" class="form-control" required value="<?php echo $sub_categories?>" style="border: 0.5px solid #d9e0e7;
    margin-top: 10px;
    margin-bottom: 10px;">
								</div>
