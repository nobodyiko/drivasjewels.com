...
$sql="select * from sub_banner order by id asc";
	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Sub Banner - 01 </h4>
				</div>
				<div class="card-body--">
...
echo "<a target='_blank' href='".BANNER_SITE_PATH.$row['image']."'><img width='150px' src='".BANNER_SITE_PATH.$row['image']."'/></a>";
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='manage_sub_banner.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
