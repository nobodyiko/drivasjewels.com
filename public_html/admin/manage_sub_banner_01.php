...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	$image_required='';
	$res=mysqli_query($con,"select * from sub_banner_01 where id='$id'");
	...
	if($check>0){
		...
		$image=$row['image'];
		 ...
		 ?>
	    <script>
	        window.location.href='sub_banner_01.php';
	    </script>
	    <?php
		die();
	}
...
move_uploaded_file($_FILES['image']['tmp_name'], $_SERVER['DOCUMENT_ROOT'] . "/media/banner/" . $image);
				$update_sql="update sub_banner_01 set image='$image' where id='$id'";
			}
...
mysqli_query($con, "insert into sub_banner_01(image) values('$image')");
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Sub Banner - 02</strong><small> Form</small></div>
