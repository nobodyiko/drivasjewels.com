...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	$image_required='';
	$res=mysqli_query($con,"select * from sub_banner_03 where id='$id'");
	...
	if($check>0){
		...
		$image=$row['image'];
		 ...
		 ?>
	    <script>
	        window.location.href='sub_banner_04.php';
	    </script>
	    <?php
		die();
	}
...
move_uploaded_file($_FILES['image']['tmp_name'], $_SERVER['DOCUMENT_ROOT'] . "/media/banner/" . $image);
				$update_sql="update sub_banner_03 set heading1='$heading1',heading2='$heading2',btn_txt='$btn_txt',btn_link='$btn_link',image='$image' where id='$id'";
			}else{
				$update_sql="update sub_banner_03 set heading1='$heading1',heading2='$heading2',btn_txt='$btn_txt',btn_link='$btn_link'  where id='$id'";
			}
...
mysqli_query($con, "insert into sub_banner_03(heading1,heading2,btn_txt,btn_link,image,status) values('$heading1','$heading2','$btn_txt','$btn_link','$image','1')");
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Sub Banner - 04</strong><small> Form</small></div>
