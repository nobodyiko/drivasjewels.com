...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='delete'){
		$id=get_safe_value($con,$_GET['id']);
	  $delete_attributes_sql = "DELETE FROM product_attributes WHERE product_id = '$id'";
    mysqli_query($con, $delete_attributes_sql);
    
    // Then, delete the product record from the product table based on the product's ID
    $delete_product_sql = "DELETE FROM product WHERE id = '$id'";
